...
namespace UniversalRecallTracker
{
    public class Program
    {
        ...
        {
            Menu menu = new Menu("花边-Universal回城监控", "universalrecalltracker", true);
            _x =
            ...
            _textSize = new MenuItem("textSize", "文本大小 (F5重载)").SetValue(new Slider(15, 5, 50));
            _chatWarning = new MenuItem("chatWarning", "聊天框提示").SetValue(false);
            _barScale = new MenuItem("barScale", "图标大小 %").SetValue(new Slider(100, 0, 200));
