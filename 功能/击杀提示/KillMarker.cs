...
namespace Essentials
{
    ...
    public class KillMarker
    {
        ...
        {
            var subMenu = Config.Menu.MainMenu.AddSubMenu("击杀提示");
            Enabled = subMenu.AddLinkedBool("启用");
            DrawIcon = subMenu.AddLinkedBool("显示 图标");
            DrawText = subMenu.AddLinkedBool("显示 文本");
        }
