    ...
    internal static class 召唤师技能
    {
        ...
        public static void Initialize(Menu root)
        {
            ...
            if (smite != SpellSlot.Unknown || _isjungling)
            {
                ...
                Smite.AddItem(new MenuItem("usesmite", "使用惩戒")).SetValue(new KeyBind('M', KeyBindType.Toggle));
                Smite.AddItem(new MenuItem("smitespell", "惩戒 + 技能")).SetValue(true);
                Smite.AddItem(new MenuItem("drawsmite", "显示惩戒范围")).SetValue(true);
                Smite.AddItem(new MenuItem("drawstatus", "显示惩戒状态")).SetValue(true);
                ...
                Smite.AddItem(new MenuItem("savesmite", "保存惩戒层数").SetValue(true));
