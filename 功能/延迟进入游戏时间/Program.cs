    ...
    internal class Program
    {
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            try
            {
                ...
                {
#if !DISABLED
                    Drawing.DrawText(10, 10, Color.Red, "寤堕暦閫插叆娓告埐鏅傞枔:");

                    Color textColor = Color.LightYellow;
                    switch (Stage)
                    {
                        case 0: statusText = "绛夊緟杞熺偢"; textColor = Color.LightYellow; break;
                        case 1: statusText = "闁嬪涓ㄧ暥浣犳兂閫插叆娓告埐鐨勬檪鍊欒珛鎸変笅绌烘牸閸碉紝琛规湁250s"; textColor = Color.LimeGreen; break;
                        case 2: statusText = "鑴氭湰鍟撳嫊澶辨晥锛屾父鎴插凡缍撻枊濮嬩簡"; textColor = Color.Turquoise; break;
                    }
