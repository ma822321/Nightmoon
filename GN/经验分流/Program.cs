...
namespace SharedExperience
{
    class Program
    {
        ...
        public static void OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("<font color=\"#00BFFF\">鑺遍倞灏忓眿鍑哄搧 </font> Shared Experience <font color=\"#FFFFFF\">鍔犺級 鎴愬姛!</font>");
        }
        ...
        {
            menu = new Menu("花边汉化-检测经验分流", "Shared Experience", true);
            ...
            menu.AddItem(new MenuItem("drawPredictionCircle", "有不可见敌人存在时丨显示预警线圈e").SetValue(true));
            ...
            menu.AddItem(new MenuItem("posX", "英雄 横坐标").SetValue(new Slider(1800, 0, 1920)));
            menu.AddItem(new MenuItem("posY", "英雄 纵坐标").SetValue(new Slider(670, 0, 1080)));
            menu.AddToMainMenu();
        }
    }
}
