    ...
    internal class ActivatorOld
    {
        ...
        private void UseCleanse()
        {
            if (!MainMenu.ActivatorAutoSummonerSpellCleanse.GetActive())
                return;
            SpellSlot sumCleanse = SummonerSpells.GetCleanseSlot();
        ...
        private void UseIgnite()
        {
            if (!MainMenu.ActivatorAutoSummonerSpellIgnite.GetActive())
                return;
            SpellSlot sumIgnite = SummonerSpells.GetIgniteSlot();
        ...
        private void UseHealth()
        {
            ...
            SpellSlot sumHeal = SummonerSpells.GetHealSlot();
        ...
        private void UseBarrier()
        {
            ...
            SpellSlot sumBarrier = SummonerSpells.GetBarrierSlot();
        ...
        private void UseExhaust_OnGameUpdate()
        {
            ...
            SpellSlot sumExhaust = SummonerSpells.GetExhaustSlot();
