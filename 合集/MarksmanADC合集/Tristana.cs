...
namespace Marksman
{
    internal class Tristana : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseWCS" + Id, "E堆叠一定后使用W").SetValue(true));
            config.AddItem(new MenuItem("UseEC" + Id, "使用 E").SetValue(true));

            config.AddSubMenu(new Menu("禁止E 对象", "DontUseE"));
            {
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("UseETH" + Id, "使用 E (自动)").SetValue(
        ...
        public override bool DrawingMenu(Menu config)
        {
            ...
            var drawE = new Menu("Draw E", "DrawE");
            {
                ...
                drawE.AddItem(
                    new MenuItem("DrawEMarkEnemy", "E 标记敌人").SetValue(new Circle(true, Color.GreenYellow)));
                drawE.AddItem(new MenuItem("DrawEMarkStatus", "E 标记 状态").SetValue(true));
        ...
        public override bool MiscMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseRM" + Id, "使用 R 击杀").SetValue(true));
            config.AddItem(new MenuItem("UseRMG" + Id, "使用 R 防突进").SetValue(true));
            config.AddItem(new MenuItem("UseRMI" + Id, "使用 R 打断").SetValue(true));
            return true;
        }
