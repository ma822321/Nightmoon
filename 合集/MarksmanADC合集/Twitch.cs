...
namespace Marksman
{
    internal class Twitch : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEC" + Id, "使用 E 丨 最大层数").SetValue(true));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEH" + Id, "使用 E 丨 最大层数").SetValue(false));
            return true;
        }
        ...
        {
            config.AddItem(new MenuItem("UseEM" + Id, "使用 E 抢人头").SetValue(true));
            return true;
        }
