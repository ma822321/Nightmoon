...
//        public static Menu MenuInterruptableSpell;
        ...
        {
            Config = new Menu("花边-MMAAdc合集", "Marksman", true);
            CClass = new Champion();
            ...
            if (BaseType != CClass.GetType())
            {
                ...
                {
                    harass.AddItem(new MenuItem("HarassMana", "最低蓝量比").SetValue(new Slider(50, 100, 0)));
                ...
                {
                    laneclear.AddItem(
                        new MenuItem("LaneClearMana", "最低蓝量比").SetValue(new Slider(50, 100, 0)));
                ...
                */
                ...
                {
                    drawing.AddItem(
                        new MenuItem("drawMinionLastHit", "小兵补刀").SetValue(new Circle(false,
                            System.Drawing.Color.GreenYellow)));
                    drawing.AddItem(
                        new MenuItem("drawMinionNearKill", "附近可击杀小兵").SetValue(new Circle(false,
                            System.Drawing.Color.Gray)));
                    drawing.AddItem(new MenuItem("drawJunglePosition", "无伤打野点").SetValue(true));
