...
namespace Marksman
{
    internal class Kogmaw : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("RlimC" + Id, "R 限制人数").SetValue(new Slider(3, 5, 1)));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("RlimH" + Id, "R 限制人数").SetValue(new Slider(1, 5, 1)));
            return true;
        }
        ...
        public override bool DrawingMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("DrawW" + Id, "W 范围").SetValue(new Circle(true,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
