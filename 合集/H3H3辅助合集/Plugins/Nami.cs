...
namespace Support.Plugins
{
    ...
    public class Nami : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("ComboHealthW", "生命回复", 20, 1, 100);
        }
        ...
        public override void HarassMenu(Menu config)
        {
            ...
            config.AddSlider("HarassHealthW", "生命回复", 20, 1, 100);
        }

        public override void MiscMenu(Menu config)
        {
            var sub = config.AddSubMenu(new Menu("使用 E丨攻击时", "Misc.E.AA.Menu"));
        ...
        {
            config.AddBool("GapcloserQ", "使用 Q 丨阻止突进", true);

            config.AddBool("InterruptQ", "使用 Q 丨打断法术", true);
            config.AddBool("InterruptR", "使用 R 丨打断法术", true);
        }
    }
}