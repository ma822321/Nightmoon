...
namespace Sharpshooter.Champions
{
    public static class Twitch
    {
        ...
        public static void Load()
        {
            ...
            var drawDamageMenu = new MenuItem("Draw_EDamage", "显示E伤害", true).SetValue(true);
            ...
            SharpShooter.Menu.SubMenu("Combo").AddItem(new MenuItem("comboUseEStack", "自动 E 堆叠 >=", true).SetValue(new Slider(6, 1, 6)));
            ...
            SharpShooter.Menu.SubMenu("Harass").AddItem(new MenuItem("harassUseEStack", "自动 E 堆叠 >=", true).SetValue(new Slider(4, 1, 6)));
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("stealthrecall", "隐身 回城", true).SetValue(new KeyBind('T', KeyBindType.Press)));

            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "AA 范围", true).SetValue(new Circle(true, Color.LightGreen)));
            ...
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingQTimer", "隐身 倒计时", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingRTimer", "R 倒计时", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingRLine", "R 穿透", true).SetValue(true));
