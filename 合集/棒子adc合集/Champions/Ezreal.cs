...
namespace Sharpshooter.Champions
{
    public static class Ezreal
    {
        ...
        public static void Load()
        {
            ...
            var drawFill = new MenuItem("Draw_Fill", "显示 R伤害", true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));
            ...
            SharpShooter.Menu.SubMenu("Harass").AddItem(new MenuItem("harassAuto", "自动骚扰 (自动)", true).SetValue(new KeyBind('T', KeyBindType.Toggle, true)));
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("killsteal", "抢人头", true).SetValue(false));
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("jump", "跳到鼠标位置", true).SetValue(new KeyBind('G', KeyBindType.Press)));

            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "AA 范围", true).SetValue(new Circle(true, Color.FromArgb(250, 244, 192))));
