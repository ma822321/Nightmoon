...
namespace Sharpshooter.Champions
{
    public static class Jinx
    {
        ...
        public static void Load()
        {
            ...
            var drawDamageMenu = new MenuItem("Draw_RDamage", "显示 W R伤害", true).SetValue(true);
            var drawFill = new MenuItem("Draw_Fill", "显示 W R 充能伤害", true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));
            ...
            SharpShooter.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearQnum", "小兵数 >=", true).SetValue(new Slider(2, 2, 7)));
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("AutoE", "使用 E丨目标被控制", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("FISHBONES", "切换Q丨敌人数 >=", true).SetValue(new Slider(2, 2, 5)));

            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "AA 范围", true).SetValue(new Circle(true, Color.HotPink)));
            ...
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingPTimer", "被动 倒计时", true).SetValue(true));
