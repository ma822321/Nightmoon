    ...
    class Irelia : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var spellMenu = new Menu("技能 设置", "SpellMenu");
            {
                ...
                {
                    qMenu.AddItem(new MenuItem("Q_Min_Distance", "Q 最小范围", true).SetValue(new Slider(300, 0, 600)));
                    qMenu.AddItem(new MenuItem("Q_Gap_Close", "Q小兵丨突进别人", true).SetValue(true));
                    qMenu.AddItem(new MenuItem("Q_Under_Tower", "塔下Q突进", true).SetValue(false));
                    spellMenu.AddSubMenu(qMenu);
                }

                var eMenu = new Menu("E", "EMenu");
                {
                    eMenu.AddItem(new MenuItem("E_Only_Stun", "保存 E丨眩晕别人", true).SetValue(true));
                    eMenu.AddItem(new MenuItem("E_Running", "对逃跑的敌人释放E", true).SetValue(true));
            ...
            var farm = new Menu("清 线", "LaneClear");
            {
                ...
                farm.AddItem(new MenuItem("UseQFarm_Tower", "塔下禁止Q", true).SetValue(true));
            ...
            var miscMenu = new Menu("杂 项", "Misc");
            {
                ...
                miscMenu.AddItem(new MenuItem("QE_Interrupt", "使用 Q/E丨打断法术", true).SetValue(true));
                //add to menu
            ...
            var drawMenu = new Menu("范 围", "Drawing");
            {
                ...
                drawMenu.AddItem(new MenuItem("Draw_R_Killable", "标记 R 可击杀", true).SetValue(true));
