    ...
    class Jayce : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("按 键", "Keys"); { 
                ...
                key.AddItem(new MenuItem("shootMouse", "向鼠标处 射击QE", true).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                menu.AddSubMenu(key);
            }
            ...
            var combo = new Menu("连 招", "Combo"); { 
                ...
                combo.AddItem(new MenuItem("UseRCombo", "使用 R 切换状态", true).SetValue(true));
            ...
            var harass = new Menu("骚 扰", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("UseQHarassHam", "使用 锤形态 Q", true).SetValue(true));
                harass.AddItem(new MenuItem("UseWHarassHam", "使用 锤形态 W", true).SetValue(true));
                harass.AddItem(new MenuItem("UseEHarassHam", "使用 锤形态 E", true).SetValue(true));
                harass.AddItem(new MenuItem("UseRHarass", "使用 R 切换状态", true).SetValue(true));
                harass.AddItem(new MenuItem("manaH", "MP > %", true).SetValue(new Slider(40)));
            ...
            var misc = new Menu("杂 项", "Misc"); {
                ...
                misc.AddItem(new MenuItem("forceGate", "QE连招", true).SetValue(false));
                misc.AddItem(new MenuItem("gatePlace", "E距离", true).SetValue(new Slider(300, 50, 600)));
                misc.AddItem(new MenuItem("UseQAlways", "使用 Q丨E在CD中", true).SetValue(true));
                misc.AddItem(new MenuItem("autoE", "E推走目标丨 HP < %", true).SetValue(new Slider(20)));
                misc.AddItem(new MenuItem("smartKS", "智能击杀系统", true).SetValue(true));
            ...
            var drawMenu = new Menu("范 围", "Drawings"); {
                ...
                drawMenu.AddItem(new MenuItem("Draw_Q", "显示 Q 炮形态", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_QExtend", "显示Q 炮形态 额外范围", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E", "显示 E 炮形态", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_Q2", "显示 Q 锤形态", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E2", "显示 E 锤形态", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("drawcds", "显示 冷却", true).SetValue(true));
