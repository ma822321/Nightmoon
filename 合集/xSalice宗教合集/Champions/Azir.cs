    ...
    class Azir : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("按 键", "Key");
            {
                ...
                key.AddItem(new MenuItem("escape", "奔跑吧 脆皮鸡", true).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("insec", "Insec 选择 目标",true).SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("qeCombo", "Q->E 眩晕 最近的目标",true).SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("qMulti", "Q 丨有 2+士兵",true).SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("point", "逃跑到指定位置(仅逃跑)", true).SetValue(new KeyBind("M".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var spell = new Menu("技能 设置", "Spell");
            {
                ...
                var qMenu = new Menu("Q", "QSpell"); { 
                    qMenu.AddItem(new MenuItem("qOutRange", "目标离开范围丨仅使用Q",true).SetValue(false));
                    qMenu.AddItem(new MenuItem("qExtend", "使用Q 额外范围",true).SetValue(true));
                    qMenu.AddItem(new MenuItem("qHit", "Q 命中",true).SetValue(new Slider(3, 1, 3)));
                    spell.AddSubMenu(qMenu);
                }
                //W Menu
                var wMenu = new Menu("W", "WSpell"); {
                    wMenu.AddItem(new MenuItem("wAtk", "附近有敌人就召唤",true).SetValue(true));
                ...
                {
                    eMenu.AddItem(new MenuItem("eKill", "击杀连招使用",true).SetValue(false));
                    eMenu.AddItem(new MenuItem("eKnock", "一直 预判伤害",true).SetValue(false));
                    eMenu.AddItem(new MenuItem("eHP", "HP >",true).SetValue(new Slider(100)));
                    spell.AddSubMenu(eMenu);
                }
                //R Menu
                var rMenu = new Menu("R", "RSpell");{
                    rMenu.AddItem(new MenuItem("rHP", "HP <",true).SetValue(new Slider(20)));
                    rMenu.AddItem(new MenuItem("rHit", "打中 >= 目标",true).SetValue(new Slider(3, 0, 5)));
                    rMenu.AddItem(new MenuItem("rWall", "R阻止敌人接近",true).SetValue(true));
            ...
            var killSteal = new Menu("击 杀", "KillSteal");
            {
                ...
                killSteal.AddItem(new MenuItem("eKS", "使用 E", true).SetValue(false));
                killSteal.AddItem(new MenuItem("wqKS", "使用 WQ", true).SetValue(true));
                killSteal.AddItem(new MenuItem("qeKS", "使用 WQE", true).SetValue(false));
                killSteal.AddItem(new MenuItem("rKS", "使用 R", true).SetValue(true));
            ...
            var farm = new Menu("打 钱", "Farm");
            {
                ...
                farm.AddItem(new MenuItem("qFarm", "只 Q丨小兵数>",true).SetValue(new Slider(3, 0, 5)));
            ...
            {
                misc.AddItem(new MenuItem("UseInt", "使用 E 丨打断法术", true).SetValue(true));
                misc.AddItem(new MenuItem("UseGap", "使用 R 丨阻止突进", true).SetValue(true));
                misc.AddItem(new MenuItem("fastEscape", "快速 逃跑 = on, EQ逃跑(有延迟) = off",true).SetValue(true));
                misc.AddItem(new MenuItem("escapeDelay", "逃跑 延迟", true).SetValue(new Slider(0, 0, 300)));
                menu.AddSubMenu(misc);
            }

            //Drawings menu:
            var draw = new Menu("范 围", "Drawings"); { 
                draw.AddItem(new MenuItem("QRange", "Q 范围",true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
                draw.AddItem(new MenuItem("QExtendRange", "Q 额外 范围",true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
                ...
                draw.AddItem(new MenuItem("slaveDmg", "显示 傀儡 AA",true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
