...
namespace xSaliceReligionAIO.Champions
{
    class Karthus : Champion
    {
        ...
        {
            //Keys
            var keys = new Menu("按 键", "Keys");
            {
                keys.AddItem(new MenuItem("ComboActive", "连招 按键!", true).SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
                keys.AddItem(new MenuItem("HarassActive", "骚扰 按键!", true).SetValue(new KeyBind("S".ToCharArray()[0], KeyBindType.Press)));
                keys.AddItem(new MenuItem("HarassActiveT", "骚扰 (自动)!", true).SetValue(new KeyBind("Y".ToCharArray()[0], KeyBindType.Toggle)));
                keys.AddItem(new MenuItem("wTar", "扔 W到目标那", true).SetValue(new KeyBind("W".ToCharArray()[0], KeyBindType.Press)));
                keys.AddItem(new MenuItem("lastHitQ", "Q 补刀", true).SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                keys.AddItem(new MenuItem("LaneClearActive", "打钱 按键!", true).SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
            ...
            var spells = new Menu("技能 设置", "Spell"); { 
                ...
                { 
                    ...
                    qMenu.AddItem(new MenuItem("qImmo", "自动 Q (无法移动)", true).SetValue(true));
                    qMenu.AddItem(new MenuItem("qDash", "自动 Q (突进)", true).SetValue(true));
                ...
                {
                    wMenu.AddItem(new MenuItem("wTower", "自动 W丨敌人在塔下", true).SetValue(true));
                    wMenu.AddItem(new MenuItem("wIfMana", "有蓝只W", true).SetValue(true));
                    spells.AddSubMenu(wMenu);
                }

                //E
                var eMenu = new Menu("E", "ESpell"); { 
                    eMenu.AddItem(new MenuItem("eManaCombo", "连招最低蓝量", true).SetValue(new Slider(10)));
                    eMenu.AddItem(new MenuItem("eManaHarass", "骚扰最低蓝量", true).SetValue(new Slider(70)));
                ...
                {
                    rMenu.AddItem(new MenuItem("rPing", "本地提示可击杀", true).SetValue(true));
            ...
            var combo = new Menu("连 招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("qHit", "Q 命中", true).SetValue(new Slider(3, 1, 4)));
            ...
            var harass = new Menu("骚 扰", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("qHit2", "Q 命中", true).SetValue(new Slider(3, 1, 4)));
                ...
                harass.AddItem(new MenuItem("minMana", "最低蓝量 >", true).SetValue(new Slider(60)));
            ...
            {
                misc.AddItem(new MenuItem("UseInt", "使用 E丨打断法术", true).SetValue(true));
                misc.AddItem(new MenuItem("UseGap", "使用 E丨阻止突进", true).SetValue(true));
            ...
            { 
                ...
                drawMenu.AddItem(new MenuItem("drawUlt", "大招 击杀", true).SetValue(true));
