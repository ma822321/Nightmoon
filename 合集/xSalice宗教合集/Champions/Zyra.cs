    ...
    class Zyra : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("按 键", "Key");
            {
                ...
                key.AddItem(new MenuItem("Escape", "逃跑时丨使用 E", true).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var combo = new Menu("连 招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("R_Min", "使用 R丨敌人数 >=, 6 = 关闭使用R", true).SetValue(new Slider(3, 1, 6)));
                //add to menu
            ...
            {
                misc.AddItem(new MenuItem("E_GapCloser", "使用 E丨阻止突进", true).SetValue(true));
                misc.AddItem(new MenuItem("smartKS", "智能 击杀", true).SetValue(true));
                misc.AddItem(new MenuItem("Auto_Bloom", "敌人接近丨自动激活种子", true).SetValue(true));
                //add to menu
            ...
            {
                drawing.AddItem(new MenuItem("Draw_Disabled", "禁止 所有 范围", true).SetValue(false));
                drawing.AddItem(new MenuItem("Draw_Q", "显示 Q 范围", true).SetValue(true));
                drawing.AddItem(new MenuItem("Draw_W", "显示 Q 范围", true).SetValue(true));
                drawing.AddItem(new MenuItem("Draw_E", "显示 E 范围", true).SetValue(true));
                drawing.AddItem(new MenuItem("Draw_R", "显示 R 范围", true).SetValue(true));
