...
namespace MAC.Util
{
    class MiscControl
    {
        ...
        public static String stringColor(string texto, string color)
        {
        ...
        {
            Game.PrintChat("<font color='#07c7dd'>MAC: </font> <font color='#FFFFFF'>" + msg + "</font>");
        }


        public static void LoadOrbwalker()
        {
            var orbMenu = new Menu("走砍", "orbStand");
            var orbwalk = new Orbwalking.Orbwalker(orbMenu);
            orbMenu.AddToMainMenu();
        }
