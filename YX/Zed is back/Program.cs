    ...
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Youmuu", "使用 Youmuu's")).SetValue(true);
                _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Tiamat", "使用 Tiamat")).SetValue(true);
                _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Hydra", "使用 Hydra")).SetValue(true);
                ...
                _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Blade", "使用 Blade")).SetValue(true);
                _config.SubMenu("items")
                    .SubMenu("Offensive")
                ...
                _config.SubMenu("Farm")
                    .SubMenu("LaneFarm")
                    .AddItem(new MenuItem("UseItemslane", "使用 Hydra/Tiamat"))
                    .SetValue(true);
                ...
                _config.SubMenu("Farm")
                    .SubMenu("Jungle")
                    .AddItem(new MenuItem("UseItemsjungle", "使用 Hydra/Tiamat"))
                    .SetValue(true);
