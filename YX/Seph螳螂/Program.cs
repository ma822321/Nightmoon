...
namespace SephKhazix
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("花边汉化-Seph螳螂", "Khazix", true);
            ...
            Config.SubMenu("autopoke").AddItem(new MenuItem("AutoHarrass", "自动 骚扰")).SetValue(true);
            Config.SubMenu("autopoke").AddItem(new MenuItem("AutoWI", "自动-W 不动")).SetValue(true);
            ...
            Config.SubMenu("Packets").AddItem(new MenuItem("usePackets", "开启 封包").SetValue(false));
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseEGapclose", "使用 E 突进再用Q")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseEGapcloseW", "使用 E 突进再用W")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRGapcloseW", "使用 R 进行长距离突进")).SetValue(true);
            ...
            Config.SubMenu("Combo")
                .AddItem(new MenuItem("Combo", "连招 按键!").SetValue(new KeyBind(32, KeyBindType.Press)));
            ...
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("Harass", "骚扰 按键!").SetValue(
                        new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));

            //Farm
            Config.AddSubMenu(new Menu("清线/清野", "Farm"));
            ...
            Config.SubMenu("Farm").AddItem(new MenuItem("UseItemsFarm", "使用 物品")).SetValue(true);
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("WaveFarm", "清线 按键!").SetValue(
                        new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("JungleFarm", "清野 按键!").SetValue(
                        new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));

            //Kill Steal
            Config.AddSubMenu(new Menu("抢人头", "Ks"));
            Config.SubMenu("Ks").AddItem(new MenuItem("Kson", "开 启")).SetValue(true);
            ...
            Config.SubMenu("Ks").AddItem(new MenuItem("UseEQKs", "使用 EQ")).SetValue(true);
            Config.SubMenu("Ks").AddItem(new MenuItem("UseEWKs", "使用 EW")).SetValue(false);
            Config.SubMenu("Ks").AddItem(new MenuItem("UseTiaKs", "使用 物品")).SetValue(true);
            Config.SubMenu("Ks").AddItem(new MenuItem("Edelay", "E 延迟 (ms)").SetValue(new Slider(0, 2, 300)));
            Config.SubMenu("Ks").AddItem(new MenuItem("autoescape", "残血-使用 E")).SetValue(false);
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("CircleLag", "自由 延迟圈").SetValue(true));
            ...
            Config.SubMenu("Debug").AddItem(new MenuItem("Debugon", "开 启").SetValue(false));
            ...
            Game.PrintChat("鑺辫竟姹夊寲-Seph铻宠瀭鍔犺浇鎴愬姛!");
