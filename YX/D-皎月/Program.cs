...
namespace D_Diana
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Diana
            _config = new Menu("花边汉化-D-皎月", "D-Diana", true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("UseIgnitecombo", "使用 Ignite(rush for it)")).SetValue(true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("UseRSecond", "使用 第二段 R")).SetValue(false);
            ...
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Bilge", "使用 水银")).SetValue(true);
            ...
            _config.SubMenu("items")
                .SubMenu("Deffensive")
                .AddItem(new MenuItem("Omenenemys", "敌人数>").SetValue(new Slider(2, 1, 5)));
            _config.SubMenu("items")
                .SubMenu("Deffensive")
            ...
            _config.SubMenu("items")
                .SubMenu("Deffensive")
                .AddItem(new MenuItem("lotisminhp", "友军 Hp<").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("items").AddSubMenu(new Menu("药 剂", "Potions"));
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usehppotions", "使用 补血"))
                .SetValue(true);
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionhp", "HP % <").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usemppotions", "使用 补蓝"))
                .SetValue(true);
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionmp", "MP % <").SetValue(new Slider(35, 1, 100)));
            ...
            _config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("harasstoggle", "骚扰(自动)").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Toggle)));
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("Harrasmana", "骚扰丨最低蓝量").SetValue(new Slider(60, 1, 100)));
            ...
            _config.SubMenu("Farm").AddSubMenu(new Menu("清 线", "Lane"));
            ...
            _config.SubMenu("Farm")
                .SubMenu("Jungle")
                .AddItem(
                    new MenuItem("ActiveJungle", "清野 按键").SetValue(new KeyBind("V".ToCharArray()[0],
                        KeyBindType.Press)));
            _config.SubMenu("Farm")
                .SubMenu("Jungle")
                .AddItem(new MenuItem("Junglemana", "最低 蓝量").SetValue(new Slider(60, 1, 100)));
            ...
            _config.SubMenu("Smite")
                .AddItem(new MenuItem("manaJ", "MP% <").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Smite").AddItem(new MenuItem("Usered", "红buff")).SetValue(true);
            _config.SubMenu("Smite")
                .AddItem(new MenuItem("healthJ", "HP% <").SetValue(new Slider(35, 1, 100)));
           ...
           // _config.SubMenu("Misc").AddItem(new MenuItem("Shieldper", "Self Health %")).SetValue(new Slider(40, 1, 100));
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("Gap_W", "使用 W丨防突進")).SetValue(true);

            //Kill Steal
            _config.AddSubMenu(new Menu("击 杀", "Ks"));
            _config.SubMenu("Ks").AddItem(new MenuItem("ActiveKs", "开 启")).SetValue(true);
            ...
            _config.SubMenu("Ks")
                .AddItem(new MenuItem("TargetRange", "使用R丨范围 >").SetValue(new Slider(400, 200, 600)));
            ...
            _config.SubMenu("Drawings").AddItem(new MenuItem("DrawQ", "显示 Q 范围")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("DrawW", "显示 W 范围")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("DrawE", "显示 E 范围")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("DrawR", "显示 R 范围")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(dmgAfterComboItem);
            _config.SubMenu("Drawings").AddItem(new MenuItem("Drawsmite", "显示 惩戒")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("ShowPassive", "显示 通知")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("combotext", "显示 选择 连招")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("CircleLag", "自由 延迟圈").SetValue(true));
            ...
            Game.PrintChat("鑺辫竟姹夊寲-D鐨庢湀鍔犺浇鎴愬姛!");
