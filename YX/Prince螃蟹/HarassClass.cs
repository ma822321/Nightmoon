...
namespace Prince_Urgot
{
    internal class HarassClass
    {
        ...
        {
            HarassMenu.AddSubMenu(new Menu("骚 扰", "harass"));
            ...
            HarassMenu.SubMenu("harass").AddItem(new MenuItem("HaraManaPercent", "骚扰最小蓝量比").SetValue(new Slider(30, 0, 100)));
            HarassMenu.SubMenu("harass").AddItem(new MenuItem("harassToggle", "骚扰 自动").SetValue(new KeyBind('T', KeyBindType.Toggle)));
        }
