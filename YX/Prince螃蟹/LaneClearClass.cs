...
namespace Prince_Urgot
{
    internal class LaneClearClass
    {
        ...
        {
            LaneClearMenu.AddSubMenu(new Menu("清 线", "laneclear"));
            ...
            LaneClearMenu.SubMenu("laneclear").AddItem(new MenuItem("LaneClearManaPercent", "清线最小蓝量比").SetValue(new Slider(30, 0, 100)));
        }
