...
namespace Prince_Urgot
{
    internal class DrawingClass
    {
        ...
        {
            DrawMenu.AddSubMenu(new Menu("范 围", "drawing"));
            DrawMenu.SubMenu("drawing").AddItem(new MenuItem("drawQ", "显示 Q 范围").SetValue(new Circle(true, Color.AntiqueWhite)));
            DrawMenu.SubMenu("drawing").AddItem(new MenuItem("drawE", "显示 E 范围").SetValue(new Circle(true, Color.AntiqueWhite)));
            DrawMenu.SubMenu("drawing").AddItem(new MenuItem("drawR", "显示 R 范围").SetValue(new Circle(true, Color.AntiqueWhite)));
            DrawMenu.SubMenu("drawing").AddItem(new MenuItem("drawEHit", "显示额外 Q 范围丨E命中").SetValue(new Circle(true, Color.AntiqueWhite)));
            DrawMenu.SubMenu("drawing").AddItem(new MenuItem("hitbye", "显示敌人线圈丨E命中").SetValue(true));
        }
