...
namespace Princess_LeBlanc
{
    class Program
    {
        ...
        {
            LeBlancConfig = new Menu("Princess [Feeeez汉化]" + ObjectManager.Player.ChampionName, "Princess" + ObjectManager.Player.ChampionName, true);
            ...
            LeBlancConfig.SubMenu("Combo").AddItem(new MenuItem("ComboActive", "按键!").SetValue(new KeyBind(LeBlancConfig.Item("Orbwalk").GetValue<KeyBind>().Key, KeyBindType.Press)));
            ...
            LeBlancConfig.SubMenu("Combo").AddItem(new MenuItem("preE", "最低命中率 E").SetValue(new StringList((new[] { "Low", "Medium", "High", "Very High" }), 2)));
            LeBlancConfig.SubMenu("Combo").AddItem(new MenuItem("preR", "最低命中率 R(E)").SetValue(new StringList((new[] { "Low", "Medium", "High", "Very High" }), 2)));

            LeBlancConfig.AddSubMenu(new Menu("清线", "laneclear"));
            LeBlancConfig.SubMenu("laneclear").AddItem(new MenuItem("laneClearActive", "按键").SetValue(new KeyBind(LeBlancConfig.Item("LaneClear").GetValue<KeyBind>().Key, KeyBindType.Press)));
            ...
            LeBlancConfig.SubMenu("laneclear").AddItem(new MenuItem("LaneClear2W", "使用 二段 W").SetValue(true));
            LeBlancConfig.SubMenu("laneclear").AddItem(new MenuItem("LaneClearWHit", "最小距离施放个数 by W").SetValue(new Slider(2, 0, 5)));
            LeBlancConfig.SubMenu("laneclear").AddItem(new MenuItem("LaneClearManaPercent", "最少蓝量药水设置").SetValue(new Slider(30)));

            LeBlancConfig.AddSubMenu(new Menu("骚扰", "harass"));
            LeBlancConfig.SubMenu("harass").AddItem(new MenuItem("HarassActive", "按键!").SetValue(new KeyBind(LeBlancConfig.Item("Farm").GetValue<KeyBind>().Key, KeyBindType.Press)));
            ...
            LeBlancConfig.SubMenu("harass").AddItem(new MenuItem("use2W", "使用 二段 W").SetValue(true));
            LeBlancConfig.SubMenu("harass").AddItem(new MenuItem("useE", "使用 E").SetValue(true));
            LeBlancConfig.SubMenu("harass").AddItem(new MenuItem("HarassManaPercent", "最少蓝量药水设置").SetValue(new Slider(30)));
            LeBlancConfig.SubMenu("harass").AddItem(new MenuItem("haraKey", "自动转换").SetValue(new KeyBind('Y', KeyBindType.Toggle)));
            ...
            LeBlancConfig.SubMenu("items").AddItem(new MenuItem("minZho", "中亚最低使用血量%").SetValue(new Slider(5)));
            ...
            LeBlancConfig.SubMenu("items").SubMenu("hp").AddItem(new MenuItem("minHp", "最低血量%").SetValue(new Slider(30)));
            ...
            LeBlancConfig.SubMenu("items").SubMenu("mp").AddItem(new MenuItem("minMp", "最低蓝量%").SetValue(new Slider(30)));

            LeBlancConfig.AddSubMenu(new Menu("逃跑", "Flee"));
            LeBlancConfig.SubMenu("Flee").AddItem(new MenuItem("FleeK", "按键").SetValue(new KeyBind('A', KeyBindType.Press)));
            ...
            LeBlancConfig.SubMenu("Flee").AddItem(new MenuItem("FleeSecondW", "使用二段W逃跑").SetValue(true));
            ...
            MenuItem drawComboDamageMenu = new MenuItem("Draw_ComboDamage", "显示连招实际伤害", true).SetValue(true);
            MenuItem drawFill = new MenuItem("Draw_Fill", "显示连招中造成的伤害", true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));
            ...
            LeBlancConfig.SubMenu("Misc").AddSubMenu(new Menu("二段W返回", "backW"));
            LeBlancConfig.SubMenu("Misc").SubMenu("backW").AddItem(new MenuItem("SWcountEnemy", "最小W敌人个数").SetValue(new Slider(0, 0, 5)));
            LeBlancConfig.SubMenu("Misc").SubMenu("backW").AddItem(new MenuItem("SWpos", "If Cursor is hover Second W").SetValue(true));
            LeBlancConfig.SubMenu("Misc").AddItem(new MenuItem("Interrupt", "打断目标E").SetValue(true));
            LeBlancConfig.SubMenu("Misc").AddItem(new MenuItem("Gapclose", "对突进者E").SetValue(true));
            LeBlancConfig.SubMenu("Misc").AddItem(new MenuItem("UsePacket", "封包失效").SetValue(false));
            LeBlancConfig.SubMenu("Misc").AddItem(new MenuItem("Clone", "被动克隆").SetValue(true));
