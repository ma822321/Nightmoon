...
namespace FedNocturne
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("花边汉化-Fed梦魇", ChampionName, true);
            ...
            Config.AddSubMenu(new Menu("团灭对面", "TeamFight"));
            ...
            Config.SubMenu("TeamFight").AddItem(new MenuItem("UseRHP", "使用R连招丨HP %").SetValue<Slider>(new Slider(50, 100, 10)));
            Config.SubMenu("TeamFight").AddItem(new MenuItem("ComboActive", "连招 按键!").SetValue(new KeyBind(32, KeyBindType.Press)));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("useQHit", "Q命中数").SetValue(new Slider(3, 6, 1)));            
            Config.SubMenu("LaneClear").AddItem(new MenuItem("LaneClearActive", "清线 按键!").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
            ...
            Config.SubMenu("JungleFarm").AddItem(new MenuItem("JungleFarmActive", "清野 按键!").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("AutoRHP", "自动 R丨低血量").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Misc").AddItem(new MenuItem("HPR", "低血量比例 ").SetValue<Slider>(new Slider(30, 100, 10)));
            Config.SubMenu("Misc").AddItem(new MenuItem("useR_Killableping", "低血量 通知").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("AutoRStrong", "使用R丨最先对AP AD使用").SetValue(new KeyBind("G".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Misc").AddItem(new MenuItem("MostR", "R 模式: ").SetValue(new StringList(new[] { "AD", "AP", "简单" }, 0)));            

            Config.AddSubMenu(new Menu("物 品", "Itens"));
            Menu menuUseItems = new Menu("使用 物品", "menuUseItems");
            Config.SubMenu("Itens").AddSubMenu(menuUseItems);

            TargetedItems = new Menu("单一 物品", "menuTargetItems");
            menuUseItems.AddSubMenu(TargetedItems);
            TargetedItems.AddItem(new MenuItem("item3153", "破 败").SetValue(true));
            TargetedItems.AddItem(new MenuItem("item3143", "兰 顿").SetValue(true));
            TargetedItems.AddItem(new MenuItem("item3144", "水银 刀").SetValue(true));
            TargetedItems.AddItem(new MenuItem("item3146", "海克斯科技枪").SetValue(true));
            ...
            NoTargetedItems.AddItem(new MenuItem("item3180", "奥丁面纱").SetValue(true));
            NoTargetedItems.AddItem(new MenuItem("item3131", "神圣之剑").SetValue(true));
            NoTargetedItems.AddItem(new MenuItem("item3074", "九头蛇").SetValue(true));
            NoTargetedItems.AddItem(new MenuItem("item3077", "提亚玛特 ").SetValue(true));
            NoTargetedItems.AddItem(new MenuItem("item3142", "幽梦").SetValue(true));

            Config.AddSubMenu(new Menu("范 围", "Drawing"));
            Config.SubMenu("Drawing").AddItem(new MenuItem("Draw_Disabled", "禁止 所有 范围").SetValue(false));
            Config.SubMenu("Drawing").AddItem(new MenuItem("Draw_Q", "显示 Q 范围").SetValue(true));
            Config.SubMenu("Drawing").AddItem(new MenuItem("Draw_E", "显示 E 范围").SetValue(true));
            Config.SubMenu("Drawing").AddItem(new MenuItem("Draw_R", "显示 R 范围").SetValue(true));
