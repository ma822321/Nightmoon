...
namespace FuckingAwesomeLeeSin
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Menu.SubMenu("Combo").AddItem(new MenuItem("ksR", "击杀 R").SetValue(false));
            Menu.SubMenu("Combo").AddItem(new MenuItem("starCombo", "开启 连招").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            ...
            waveclearMenu.AddItem(new MenuItem("sjasjsdsjs", "清线 设置"));
            ...
            waveclearMenu.AddItem(new MenuItem("sjasjjs", "清野 设置"));
            waveclearMenu.AddItem(new MenuItem("jungActive", "清野 按键").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
            ...
            insecMenu.AddItem(new MenuItem("insecMode", "左键点击 [on] 右键 [off]").SetValue(true));
            ...
            var lM = insecMenu.AddSubMenu(new Menu("点击 Insec 指令", "clickInstruct"));
            ...
            insecMenu.AddItem(new MenuItem("22222222222", "花边私人汉化-FA瞎子"));
            ...
            wardjumpMenu.AddItem(new MenuItem("j2c", "到英雄").SetValue(true));
            ...
            Menu.AddSubMenu(new Menu("信 息", "Messgae"));
            Menu.SubMenu("Message").AddItem(new MenuItem("1", "花边汉化-FA瞎子"));
            Menu.SubMenu("Message").AddItem(new MenuItem("2", "自带走砍按键与FA瞎子有冲突"));
            Menu.SubMenu("Message").AddItem(new MenuItem("3", "请自己修改好"));
