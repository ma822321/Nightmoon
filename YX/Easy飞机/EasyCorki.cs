...
namespace EasyCorki
{
    class EasyCorki : Champion
    {
        ...
        protected override void InitializeMenu()
        {
            ...
            Menu.SubMenu("Harass").AddItem(new MenuItem("Harass_rlimit", "保持导弹数量").SetValue(new Slider(3, 0, 7)));
            ...
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_rlimit", "保持导弹数量").SetValue(new Slider(3, 0, 7)));
            ...
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_damage", "Q+R 伤害指示器").SetValue(true));
        }
