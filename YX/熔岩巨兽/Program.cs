...
namespace MalphiteTheRock
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            menu = new Menu("花边汉化-石头", ChampionName, true);

            //Orbwalker submenu
            menu.AddSubMenu(new Menu("走 砍", "Orbwalking"));
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("ComboActive", "连招 按键!").SetValue(new KeyBind(menu.Item("Orbwalk").GetValue<KeyBind>().Key, KeyBindType.Press)));
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("HarassActive", "骚扰 按键!").SetValue(new KeyBind(menu.Item("Farm").GetValue<KeyBind>().Key, KeyBindType.Press)));
            ...
            menu.SubMenu("Farm").AddItem(new MenuItem("LaneClearActive", "打钱 按键!").SetValue(new KeyBind(menu.Item("LaneClear").GetValue<KeyBind>().Key, KeyBindType.Press)));
            menu.SubMenu("Farm").AddItem(new MenuItem("LastHitQQ", "使用Q补刀丨按键").SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));

            //Misc Menu:
            menu.AddSubMenu(new Menu("杂 项", "Misc"));
            menu.SubMenu("Misc").AddItem(new MenuItem("UseInt", "使用 R丨打断法术").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("useR_Hit", "使用 R丨命中人数").SetValue(new Slider(2, 5, 0)));
            ...
            Game.PrintChat("鑺辫竟姹夊寲-鐭冲ご鍔犺浇鎴愬姛!");
        }
