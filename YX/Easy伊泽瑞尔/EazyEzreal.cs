...
namespace EasyEzreal
{
    class EazyEzreal : Champion
    {
        ...
        protected override void InitializeMenu()
        {
            ...
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_minrange", "最小 R 范围").SetValue(new Slider(1050, 0, 1500)));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_maxrange", "最大 R 范围").SetValue(new Slider(3000, 1500, 5000)));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_manaE", "保持法力来使用 E").SetValue(true));
