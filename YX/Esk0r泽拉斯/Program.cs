...
namespace Xerath
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("R").AddItem(new MenuItem("rMode", "模 式").SetValue(new StringList(new[] { "正 常", "自定义 延迟", "优先 设置" })));
            Config.SubMenu("R").AddItem(new MenuItem("rModeKey", "优先人物 锁定").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("R").AddSubMenu(new Menu("自定义 延迟", "Custom delays"));
            for (int i = 1; i <= 3; i++)
            ...
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("HarassActive", "手动 骚扰!").SetValue(
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("AutoEGC", "自动E丨 阻止突进").SetValue(true));
           ...
           //             Color.FromArgb(150, Color.DodgerBlue))));
            ...
            Game.PrintChat("鑺辫竟姹夊寲-Esk0r娉芥媺鏂簿绠€鏃犵敤鍔熻兘鐗堜辅鍔犺浇鎴愬姛!");
