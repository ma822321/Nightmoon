...
namespace Graves_OnKeyToWin
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            SpellList.Add(R1);
            //Create the menu
            Config = new Menu("花边汉化-一键男枪", ChampionName, true);
            ...
            Config.AddItem(new MenuItem("smartE", "智能 E 按键").SetValue(new KeyBind('t', KeyBindType.Press))); //32 == space
            Config.AddItem(new MenuItem("AGC", "被突进时丨自动E").SetValue(true));
            Config.AddItem(new MenuItem("Hit", "Q 命中").SetValue(new Slider(2, 2, 0)));
            Config.AddItem(new MenuItem("HitR", "R 命中").SetValue(new Slider(2, 2, 0)));
            Config.AddItem(new MenuItem("useR", "手动R 按键").SetValue(new KeyBind('t', KeyBindType.Press))); //32 == space
            ...
            Game.PrintChat("<font color=\"#00BFFF\">鑺遍倞灏忓眿鍑哄搧 </font> One Key To Win - Graves V1.5 <font color=\"#FFFFFF\">鍔犺級 鎴愬姛!</font>");
        }
