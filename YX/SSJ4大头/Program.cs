...
namespace SSJ4_Heimerdinger
{
    internal class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Menu
            Config = new Menu(Champion, "花边汉化-SSJ4大头2.0", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("ActiveCombo", "连招 按键!").SetValue(new KeyBind(32, KeyBindType.Press)));
            ...
            Game.PrintChat("鑺辫竟姹夊寲-SSJ4澶уご鍔犺浇鎴愬姛!");
        }
