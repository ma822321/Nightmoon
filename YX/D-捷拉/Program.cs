...
namespace D_Zyra
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Zyra
            _config = new Menu("花边汉化-D婕拉", "D-Zyra", true);
           ...
           _config.AddSubMenu(targetSelectorMenu);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("smitecombo", "使用 惩戒")).SetValue(true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("useW_Passive", "对植物丨使用Q").SetValue(true));
            _config.SubMenu("Combo").AddItem(new MenuItem("useEC", "使用 E")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("useWE_Passive", "对植物丨使用E").SetValue(true));
            _config.SubMenu("Combo").AddItem(new MenuItem("use_ulti", "使用R丨击杀")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("UseRE", "自动R")).SetValue(true);
            _config.SubMenu("Combo")
                .AddItem(
                    new MenuItem("MinTargets", "自动R丨最小敌人数").SetValue(new Slider(2, 1, 5)));
            _config.SubMenu("Combo")
                .AddItem(new MenuItem("ActiveCombo", "连招 按键!").SetValue(new KeyBind(32, KeyBindType.Press)));

            _config.AddSubMenu(new Menu("物 品", "items"));
            ...
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Bilge", "使用 比尔沃吉特弯刀")).SetValue(true);
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("BilgeEnemyhp", "敌人 Hp <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Bilgemyhp", "自己 Hp < ").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Blade", "使用 破败")).SetValue(true);
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("BladeEnemyhp", "敌人 Hp <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Blademyhp", "自己  Hp <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Hextech", "使用 海克思科技枪")).SetValue(true);
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("HextechEnemyhp", "敌人 Hp <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Hextechmyhp", "自己 Hp <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("frostQ", "使用 冰霜女王指令")).SetValue(true);

            _config.SubMenu("items").AddSubMenu(new Menu("防 守", "Deffensive"));
            _config.SubMenu("items").SubMenu("Deffensive").AddItem(new MenuItem("Omen", "使用 兰顿")).SetValue(true);
            _config.SubMenu("items").SubMenu("Deffensive").AddItem(new MenuItem("Omenenemys", "使用蓝盾丨敌人数>").SetValue(new Slider(2, 1, 5)));
            _config.SubMenu("items").SubMenu("Deffensive").AddItem(new MenuItem("lotis", "使用 鸟盾")).SetValue(true);
            _config.SubMenu("items").SubMenu("Deffensive").AddItem(new MenuItem("lotisminhp", "使用鸟盾丨友军 Hp<").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("items").SubMenu("Deffensive").AddSubMenu(new Menu("净 化", "Cleanse"));
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").AddSubMenu(new Menu("米凯尔的坩埚", "mikael"));
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").SubMenu("mikael").AddItem(new MenuItem("usemikael", "使用坩埚移除的DeBuffs")).SetValue(true);
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").SubMenu("mikael").AddItem(new MenuItem("mikaelusehp", "友军Hp <%").SetValue(new Slider(25, 1, 100)));
            ...
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").AddItem(new MenuItem("useqss", "使用 水银")).SetValue(true);
            ...
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").AddItem(new MenuItem("suppression", "压制")).SetValue(true);
            ...
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").AddItem(new MenuItem("zedultexecute", "Zed 大招")).SetValue(true);
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").AddItem(new MenuItem("Cleansemode", "净化 模式:")).SetValue(new StringList(new string[2] { "任何时候", "连招时" }));

            _config.SubMenu("items").AddSubMenu(new Menu("药 剂", "Potions"));
            _config.SubMenu("items").SubMenu("Potions").AddItem(new MenuItem("usehppotions", "使用 补血的药剂")).SetValue(true);
            _config.SubMenu("items").SubMenu("Potions").AddItem(new MenuItem("usepotionhp", "HP % <").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("items").SubMenu("Potions").AddItem(new MenuItem("usemppotions", "使用 补蓝的药剂")).SetValue(true);
            _config.SubMenu("items").SubMenu("Potions").AddItem(new MenuItem("usepotionmp", "MP % <").SetValue(new Slider(35, 1, 100)));

            //harass
            _config.AddSubMenu(new Menu("骚 扰", "Harass"));
            _config.SubMenu("Harass").AddItem(new MenuItem("useQH", "使用 Q").SetValue(true));
            _config.SubMenu("Harass").AddItem(new MenuItem("useW_Passiveh", "对植物丨使用 Q").SetValue(true));
            _config.SubMenu("Harass").AddItem(new MenuItem("useEH", "使用 E").SetValue(true));
            _config.SubMenu("Harass").AddItem(new MenuItem("useWE_Passiveh", "对植物丨使用 E").SetValue(true));
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("harassmana", "骚扰丨蓝量% >").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("harasstoggle", "自动骚扰 (按键)").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Toggle)));
            _config.SubMenu("Harass")
                .AddItem(
            ...
            _config.SubMenu("Farm").AddSubMenu(new Menu("清 线", "LaneClear"));
            _config.SubMenu("Farm").SubMenu("LaneClear").AddItem(new MenuItem("useQL", "使用 Q").SetValue(true));
            _config.SubMenu("Farm").SubMenu("LaneClear").AddItem(new MenuItem("useW_Passivel", "对植物丨使用 Q").SetValue(true));
            _config.SubMenu("Farm").SubMenu("LaneClear").AddItem(new MenuItem("useEL", "使用 E").SetValue(true));
            _config.SubMenu("Farm").SubMenu("LaneClear").AddItem(new MenuItem("useWE_Passivel", "对植物丨使用 E").SetValue(true));
            
            _config.SubMenu("Farm")
                .SubMenu("LaneClear")
                .AddItem(new MenuItem("lanemana", "清线丨蓝量% >").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("LaneClear")
                .AddItem(
                    new MenuItem("Activelane", "清线 按键!").SetValue(new KeyBind("V".ToCharArray()[0],
                        KeyBindType.Press)));
            ...
            _config.SubMenu("Farm").SubMenu("Jungle").AddItem(new MenuItem("useW_Passivej", "对植物丨使用 Q").SetValue(true));
            _config.SubMenu("Farm").SubMenu("Jungle").AddItem(new MenuItem("useEJ", "使用 E").SetValue(true));
            _config.SubMenu("Farm").SubMenu("Jungle").AddItem(new MenuItem("useWE_Passivej", "对植物丨使用 E").SetValue(true));
            _config.SubMenu("Farm")
                .SubMenu("Jungle")
                .AddItem(new MenuItem("junglemana", "清野丨蓝量% >").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("Jungle")
                .AddItem(
            ...
            //Smite ActiveJungle
            _config.AddSubMenu(new Menu("惩 戒", "Smite"));
            ...
            _config.SubMenu("Smite")
                .AddItem(new MenuItem("manaJ", "自己 MP% <").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Smite").AddItem(new MenuItem("Usered", "红buff ")).SetValue(true);
            _config.SubMenu("Smite")
                .AddItem(new MenuItem("healthJ", "自己 HP% <").SetValue(new Slider(35, 1, 100)));

            //Misc
            _config.AddSubMenu(new Menu("杂 项", "Misc"));
            _config.SubMenu("Misc").AddItem(new MenuItem("usePackets", "使用 封包")).SetValue(false);
            _config.SubMenu("Misc").AddItem(new MenuItem("useQkill", "Q 击杀")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("useEkill", "E 击杀")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("Inter_E", "使用 E丨打断")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("Gap_E", "使用 E丨防突进")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("usefrostq", "使用冰霜女王的指令丨防突进")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("support", "辅助 模式")).SetValue(false);

            //Damage after combo:
            MenuItem dmgAfterComboItem = new MenuItem("DamageAfterCombo", "显示 连招 伤害").SetValue(true);
            ...
            //Draw
            _config.AddSubMenu(new Menu("范 围", "Drawing"));
            _config.SubMenu("Drawing").AddItem(new MenuItem("DrawQ", "显示 Q 范围").SetValue(true));
            _config.SubMenu("Drawing").AddItem(new MenuItem("DrawW", "显示 W 范围").SetValue(true));
            _config.SubMenu("Drawing").AddItem(new MenuItem("DrawE", "显示 E 范围").SetValue(true));
            _config.SubMenu("Drawing").AddItem(new MenuItem("DrawR", "显示 R 范围").SetValue(true));
            _config.SubMenu("Drawing").AddItem(dmgAfterComboItem);
            _config.SubMenu("Drawing").AddItem(new MenuItem("damagetest", "伤害 文本")).SetValue(true);
            _config.SubMenu("Drawing").AddItem(new MenuItem("Drawsmite", "显示 惩戒 范围")).SetValue(true);
            _config.SubMenu("Drawing").AddItem(new MenuItem("CircleLag", "线 圈").SetValue(true));
            ...
            Game.PrintChat("鑺辫竟姹夊寲-D濠曟媺 鍔犺浇鎴愬姛!");
            Game.PrintChat("鐩墠鏉ヨL#鐨勪换浣曡剼鏈兘鏄厤璐逛辅娣樺疂鍗栨敹璐圭殑,鎴戝崠浣犲閫煎晩");
