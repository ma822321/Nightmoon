...
namespace Mordekaiser
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            /* [ Set Menu ] */
            Config = new Menu(string.Format("Bbyyy汉化-金属", ChampionName), ChampionName, true);
            ...
            Config.AddSubMenu(new Menu("连招", "Combo"));
            {
                ...
                Config.SubMenu("Combo").AddSubMenu(new Menu("禁止使用大招到", "DontUlt"));
                {
            ...
            {
                Config.SubMenu("Harass").AddItem(new MenuItem("HarassUseQ", "使用Q").SetValue(true));
                ...
                Config.SubMenu("Harass")
                    .AddItem(
                        new MenuItem("HarassActiveT", "骚扰 (自动)!").SetValue(new KeyBind("H".ToCharArray()[0],
                            KeyBindType.Toggle)));
                Config.SubMenu("Harass")
                    .AddItem(
            ...
            Config.AddSubMenu(new Menu("范围", "Drawings"));
            {
                Config.SubMenu("Drawings")
                    .AddItem(new MenuItem("DrawW", "W 有效范围").SetValue(new Circle(true, Color.Pink)));
                Config.SubMenu("Drawings")
                    .AddItem(
                        new MenuItem("DrawWAffectedRange", "W 影响 范围").SetValue(new Circle(true, Color.Pink)));
                Config.SubMenu("Drawings")
                ...
                Config.SubMenu("Drawings")
                    .AddItem(new MenuItem("DrawAloneEnemy", "Q 孤立 目标").SetValue(new Circle(true, Color.Pink)));
                Config.SubMenu("Drawings")
                    .AddItem(new MenuItem("DrawSlavePos", "大招 灵魂 位子.").SetValue(new Circle(true, Color.Pink)));
                Config.SubMenu("Drawings")
                    .AddItem(new MenuItem("DrawSlaveRange", "大招 灵魂 范围").SetValue(new Circle(true, Color.Pink)));

                Config.SubMenu("Drawings").AddItem(new MenuItem("DrawEmpty", ""));
                Config.SubMenu("Drawings").AddItem(new MenuItem("DrawDisable", "取消 全部").SetValue(false));
                Config.SubMenu("Drawings").AddItem(new MenuItem("DrawEmpty", ""));
