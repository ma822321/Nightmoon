...
namespace Vi
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("Bbyyy汉化-蔚", "Vi", true);
            ...
            /* [ Don't Use Ult ] */
            Config.SubMenu("Combo").AddSubMenu(new Menu("禁止使用大到", "DontUlt"));
            ...
            Config.SubMenu("Combo").AddSubMenu(new Menu("团战中锁定目标", "FindHim"));
            Config.SubMenu("Combo")
                .SubMenu("FindHim")
                .AddItem(new MenuItem("ForceFocusActive", "启动目标锁定").SetValue(false));
            ...
            Config.SubMenu("Combo")
                .AddItem(
                    new MenuItem("ComboFlashQActive", "使用 闪现+Q!").SetValue(
            ...
            harassUseQ.AddItem(new MenuItem("UseQHarassDontUnderTurret", "禁止塔下使用 Q").SetValue(true));
            ...
            var menuRun = new Menu("逃跑", "Flee");
            {
                menuRun.AddItem(
                    new MenuItem("FleeActive", "逃跑!").SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
            ...
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("SmiteRange", "惩戒 范围").SetValue(
                        new Circle(false, System.Drawing.Color.FromArgb(255, 255, 255, 255))));
            Config.SubMenu("Drawings")
                .AddItem(
