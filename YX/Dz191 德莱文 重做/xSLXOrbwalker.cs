...
namespace DZDraven_Reloaded
{
    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            menuDrawing.AddItem(
                new MenuItem("orb_Draw_AARange", "平A 范围").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(
                new MenuItem("orb_Draw_AARange_Enemy", "敌人 平A 距离").SetValue(new Circle(true, Color.Pink)));
            menuDrawing.AddItem(
                new MenuItem("orb_Draw_Holdzone", "控制 区域").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(
                new MenuItem("orb_Draw_MinionHPBar", "小兵 血条").SetValue(new Circle(true, Color.Black)));
            menuDrawing.AddItem(
                new MenuItem("orb_Draw_MinionHPBar_thickness", "血条 厚度").SetValue(new Slider(1, 1, 3)));
            menuDrawing.AddItem(
                new MenuItem("orb_Draw_hitbox", "显示 打击模型").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(
                new MenuItem("orb_Draw_Lasthit", "显示 补刀血量").SetValue(new Circle(true, Color.Lime)));
            menuDrawing.AddItem(
                new MenuItem("orb_Draw_nearKill", "显示 附近可击杀 小兵").SetValue(new Circle(true, Color.Gold)));
            menu.AddSubMenu(menuDrawing);

            var menuMisc = new Menu("杂 项", "orb_Misc");
            menuMisc.AddItem(new MenuItem("orb_Misc_Holdzone", "保持 位置").SetValue(new Slider(50, 0, 200)));
            menuMisc.AddItem(new MenuItem("orb_Misc_Farmdelay", "打钱 延迟").SetValue(new Slider(0, 0, 300)));
            if (MyHero.ChampionName == "Azir")
            {
                menuMisc.AddItem(
                    new MenuItem("azir_Misc_Farmdelay", "士兵 打钱 延迟").SetValue(new Slider(0, 0, 300)));
            }
            menuMisc.AddItem(new MenuItem("orb_Misc_ExtraWindUp", "额外 结束时间").SetValue(new Slider(80, 200, 0)));
            menuMisc.AddItem(
                new MenuItem("orb_Misc_AutoWindUp", "自动设置 结束").SetValue(
                    new KeyBind("O".ToCharArray()[0], KeyBindType.Press)));
            menuMisc.AddItem(
                new MenuItem("orb_Misc_Priority_Unit", "优先 单位").SetValue(
                    new StringList(new[] { "小兵", "英雄" })));
            menuMisc.AddItem(new MenuItem("orb_Misc_Humanizer", "移动 延迟").SetValue(new Slider(80, 50, 500)));
            ...
            var menuMelee = new Menu("近 战", "orb_Melee");
            ...
            var menuModes = new Menu("走砍 模式", "orb_Modes");
            {
                ...
                modeCombo.AddItem(new MenuItem("Combo_Key", "连招 按键").SetValue(new KeyBind(32, KeyBindType.Press)));
                ...
                var modeHarass = new Menu("骚 扰", "orb_Modes_Harass");
                modeHarass.AddItem(
                    new MenuItem("Harass_Key", "骚扰 按键").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
                ...
                var modeLaneClear = new Menu("清 线", "orb_Modes_LaneClear");
                modeLaneClear.AddItem(
                    new MenuItem("LaneClear_Key", "清线 按键").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
                ...
                var modeLaneFreeze = new Menu("控 线", "orb_Modes_LaneFreeze");
                modeLaneFreeze.AddItem(
                    new MenuItem("LaneFreeze_Key", "控线 按键").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                ...
                var modeLasthit = new Menu("补 刀", "orb_Modes_LastHit");
                modeLasthit.AddItem(
                    new MenuItem("LastHit_Key", "补刀 按键").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
                ...
                var modeFlee = new Menu("逃 跑", "orb_Modes_Flee");
                modeFlee.AddItem(
                    new MenuItem("Flee_Key", "逃跑 按键").SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
            ...
            Game.PrintChat("鑺辫竟姹夊寲-xSLX璧扮爫搴撲辅鍔犺浇鎴愬姛!");
        }
