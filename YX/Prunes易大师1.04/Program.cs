...
"VeigarPrimordialBurst", "FioraDance", "NasusQAttack"};
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("花边汉化-Prunes" + "易大师", ChampName, true);
          ...
          //  SimpleTs.AddToMenu(ts);
           ...
           // var lxMenu = new Menu("LX_Orbwalker", "LXOrb");  //lx
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("useSmite", "连招时丨使用惩戒?").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("smartQ", "保存Q丨躲避技能Or突进?").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("Qks", "Q击杀?").SetValue(true));
           ...
           // Config.SubMenu("Combo").AddItem(new MenuItem("MSdiff", "Movespeed difference for Q").SetValue(new Slider(50, 0, 200)));
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("Combo2", "黏住目标 连招").SetValue(new KeyBind(67, KeyBindType.Press)));
            ...
            Game.PrintChat("<font color='#00FFFF'>鑺辫竟姹夊寲-Prunes MasterYi </font><font color='#FFFFFF'> 鍔犺浇鎴愬姛!</font>");
        }
