...
namespace Ziggs
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("花边汉化-EskOr炸弹人", ChampionName, true);
            ...
            Config.SubMenu("Harass")
                .AddItem(new MenuItem("ManaSliderHarass", "骚扰 最低蓝量").SetValue(new Slider(50, 100, 0)));
            Config.SubMenu("Harass")
                .AddItem(
            ...
            Config.SubMenu("Farm")
                .AddItem(new MenuItem("ManaSliderFarm", "打钱时 蓝量").SetValue(new Slider(25, 100, 0)));
            Config.SubMenu("Farm")
                .AddItem(
            ...
            Config.SubMenu("Misc")
                .AddItem(
                    new MenuItem("WToMouse", "向鼠标处 释放W").SetValue(
                        new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Misc").AddItem(new MenuItem("Peel", "W回防御塔").SetValue(true));
            ...
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawWRange", "W 范围").SetValue(
                        new Circle(true, Color.FromArgb(100, 255, 255, 255))));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawERange", "E 范围").SetValue(
                        new Circle(false, Color.FromArgb(100, 255, 255, 255))));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawRRange", "R 范围").SetValue(
                        new Circle(false, Color.FromArgb(100, 255, 255, 255))));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawRRangeM", "R 范围 (小地图)").SetValue(
                        new Circle(false, Color.FromArgb(100, 255, 255, 255))));
