...
namespace PerplexedNidalee
{
    public class ItemManager
    {
        ...
        public static void Initialize()
        {
            Items = new List<Item>();
            //Offensive
            Items.Add(new Item("Cutlass", "水银刀", 3144, ItemType.Offensive, 450));
            ...
            Items.Add(new Item("Gunblade", "科技枪", 3146, ItemType.Offensive, 700));
            //Defensive
            Items.Add(new Item("Seraphs", "炽天使之拥", 3040, ItemType.Defensive));
            Items.Add(new Item("Zhonyas", "中亚", 3157, ItemType.Defensive));
            //Cleanse
            Items.Add(new Item("QSS", "水银", 3140, ItemType.Cleanse));
            Items.Add(new Item("Mercurial", "坩埚", 3139, ItemType.Cleanse));
