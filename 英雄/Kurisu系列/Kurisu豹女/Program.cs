...
namespace KurisuNidalee
{
    ...
    internal class Program
    {
        ...
        {
            _mainMenu = new Menu("花边-Kurisu豹女", "nidalee", true);
            ...
            var nidaKeys = new Menu("按键", "keybindongs");
            ...
            var nidaHeals = new Menu("治愈", "hengine");
            nidaHeals.AddItem(new MenuItem("usedemheals", "启用")).SetValue(true);
            nidaHeals.AddItem(new MenuItem("sezz", "治愈生命: ")).SetValue(new StringList(new[] { "低 HP", "AD优先" }));
            nidaHeals.AddItem(new MenuItem("healmanapct", "最低蓝量 %")).SetValue(new Slider(55));
            ...
            foreach (var hero in ObjectManager.Get<Obj_AI_Hero>().Where(hero => hero.IsAlly))
            {
                ...
                nidaHeals.AddItem(new MenuItem("healpct" + hero.ChampionName, "目标治愈生命= % " + hero.ChampionName)).SetValue(new Slider(50));
            }
            ...
            nidaHarass.AddItem(new MenuItem("autoq", "自动-Q 按键")).SetValue(new KeyBind('Y', KeyBindType.Toggle));
            nidaHarass.AddItem(new MenuItem("humanqpct", "骚扰最低蓝量比 %")).SetValue(new Slider(55));
            ...
            nidaJungle.AddItem(new MenuItem("jgheal", "自动切换 治疗自己")).SetValue(true);
            nidaJungle.AddItem(new MenuItem("jgpct", "最低蓝量 %")).SetValue(new Slider(35));
            _mainMenu.AddSubMenu(nidaJungle);

            var nidalhit = new Menu("补刀", "lasthit");
            ...
            nidalhit.AddItem(new MenuItem("lhpct", "最低蓝量 %")).SetValue(new Slider(45));
            ...
            nidalc.AddItem(new MenuItem("lcpct", "最低蓝量 =  %")).SetValue(new Slider(35));
            _mainMenu.AddSubMenu(nidalc);

            var nidaD = new Menu("显示", "drawings");
            nidaD.AddItem(new MenuItem("drawQ", "显示 Q")).SetValue(new Circle(true, Color.FromArgb(150, Color.White)));
            nidaD.AddItem(new MenuItem("drawW", "显示 W")).SetValue(new Circle(true, Color.FromArgb(150, Color.White)));
            nidaD.AddItem(new MenuItem("drawE", "显示 E")).SetValue(new Circle(true, Color.FromArgb(150, Color.White)));
            nidaD.AddItem(new MenuItem("drawline", "显示 目标")).SetValue(true);
            nidaD.AddItem(new MenuItem("drawcds", "显示 CD")).SetValue(true);
            ...
            nidaM.AddItem(new MenuItem("dash", "突进Q")).SetValue(false);
            nidaM.AddItem(new MenuItem("gapp", "反突进Q")).SetValue(false);
            nidaM.AddItem(new MenuItem("imm", "Q/W无法移动的目标")).SetValue(true);
            nidaM.AddItem(new MenuItem("javelinks", "人形态击杀")).SetValue(true);
            nidaM.AddItem(new MenuItem("ksform", "自动切换形态击杀")).SetValue(true);
            _mainMenu.AddSubMenu(nidaM);

            var messageM = new Menu("信 息", "message");
            messageM.AddItem(new MenuItem("Sprite", "Kurisu-豹女"));
            messageM.AddItem(new MenuItem("Hanhua", "汉化:花边下丶情未央"));
            messageM.AddItem(new MenuItem("qqqun", "QQ群:299606556"));
            _mainMenu.AddSubMenu(messageM);

            _mainMenu.AddItem(new MenuItem("XiaoXiongMei", "带上小胸妹无形装逼"));
