...
namespace Viktor
{
    public class Program
    {
        ...
        private static void SetupMenu()
        {
            ...
            ProcessLink("comboExtend", subMenu.AddLinkedKeyBind("E额外范围", 'A', KeyBindType.Press));
            ...
            ProcessLink("waveNumE", subMenu.AddLinkedSlider("E 命中", 2, 1, 10));
            ...
            // Misc
            subMenu = menu.MainMenu.AddSubMenu("杂项");
            ProcessLink("miscInterrupt", subMenu.AddLinkedBool("使用R打断危险技能"));
            ProcessLink("miscGapcloser", subMenu.AddLinkedBool("使用W反突进"));
