    ...
    * */
    ...
    internal class Karthus
    {
        ...
        public Karthus()
        {
            ...
            (_menu = new Menu("花边-死歌Sharp", "KarthusSharp", true)).AddToMainMenu();
            ...
            var harassMenu = _menu.AddSubMenu(new Menu("骚 扰", "Harass"));
            ...
            drawMenu.AddItem(new MenuItem("drawQ", "Draw Q 范围").SetValue(new Circle(true, System.Drawing.Color.FromArgb(125, 0, 255, 0))));
