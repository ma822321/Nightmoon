    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            if (MyHero.ChampionName == "Azir")
                menuMisc.AddItem(new MenuItem("azir_Misc_Farmdelay", "士兵 打钱 延迟").SetValue(new Slider(0, 0, 300)));
            menuMisc.AddItem(new MenuItem("orb_Misc_AutoWindUp", "自动设置 结束").SetValue(new KeyBind("O".ToCharArray()[0], KeyBindType.Press)));
            ...
            menu.AddItem(new MenuItem("xSLx_info", "原作者:xSLx"));
