...
namespace EasyJinx
{
    class EasyKalista : Champion
    {
        ...
        protected override void InitializeMenu()
        {
            ...
            Menu.SubMenu("Combo").AddItem(new MenuItem("Combo_erange", "使用 E 丨目标离开攻击范围").SetValue(true));
            Menu.SubMenu("Combo").AddItem(new MenuItem("Combo_e", "使用 E 堆叠").SetValue(false));
            Menu.SubMenu("Combo").AddItem(new MenuItem("Combo_estacks", "# 堆叠数").SetValue(new Slider(4, 1, 10)));

            Menu.AddSubMenu(new Menu("骚扰", "Harass"));
            Menu.SubMenu("Harass").AddItem(new MenuItem("Harass_q", "使用 Q").SetValue(true));
            Menu.SubMenu("Harass").AddItem(new MenuItem("Harass_e", "使用 E 堆叠").SetValue(true));
            Menu.SubMenu("Harass").AddItem(new MenuItem("Harass_estacks", "# 堆叠数").SetValue(new Slider(4, 1, 10)));
            ...
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_estacks", "# 堆叠数").SetValue(new Slider(4, 1, 10)));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_ejungle", "使用 E 击杀野怪").SetValue(true));
            ...
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_edamage", "E 伤害 显示").SetValue(true));
        }
