...
namespace EasyJinx
{
    class EasyJinx : Champion
    {
        ...
        protected override void InitializeMenu()
        {
            ...
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_eslow", "使用 E 在减慢敌人上").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_estun", "使用 E 在晕眩的敌人上").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_egap", "使用 E 在接近间隙上").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_r", "使用 R").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_minrange", "R 最小范围").SetValue(new Slider(1050, 0, 1500)));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_maxrange", "R 最大范围").SetValue(new Slider(3000, 1500, 5000)));
            ...
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_w", "W 范围").SetValue(new Circle(true, System.Drawing.Color.FromArgb(100, 0, 255, 0))));
            ...
            Menu.SubMenu("Misc").AddItem(new MenuItem("Misc_wrange", "W 最小范围").SetValue(new Slider(500, 0, (int)Spells.get("W").Range)));
        }
