...
public class Xerath : Champion
{
    ...
    protected override void OnInitMenu()
    {
        ...
        SliderLinks.Add("harass_mana", harassMenu.AddLinkedSlider("保持蓝量", 200, 0, 500));
        ...
        BoolLinks.Add("auto_e_interrupt", autoMenu.AddLinkedBool("使用 E 打断", true));
        BoolLinks.Add("auto_e_slows", autoMenu.AddLinkedBool("使用 E 丨目标减速", false));
        BoolLinks.Add("auto_e_stuns", autoMenu.AddLinkedBool("使用 E 丨目标眩晕", true));
        BoolLinks.Add("auto_e_gapclosers", autoMenu.AddLinkedBool("使用 E 丨反突进", true));
        SliderLinks.Add("auto_mana", autoMenu.AddLinkedSlider("保持蓝量", 200, 0, 500));

        MenuWrapper.SubMenu drawingMenu = Menu.MainMenu.AddSubMenu("显示");
        BoolLinks.Add("drawing_q", drawingMenu.AddLinkedBool("显示 Q 范围", true));
        BoolLinks.Add("drawing_w", drawingMenu.AddLinkedBool("显示 W 范围", true));
        BoolLinks.Add("drawing_e", drawingMenu.AddLinkedBool("显示 E 范围", true));
        BoolLinks.Add("drawing_r", drawingMenu.AddLinkedBool("显示 R 范围", true));
        BoolLinks.Add("drawing_r_map", drawingMenu.AddLinkedBool("显示 R 范围(小地图)", true));
        ...
        KeyLinks.Add("misc_e", miscMenu.AddLinkedKeyBind("手动 E 按键", 'T', KeyBindType.Press));
        BoolLinks.Add("misc_w", miscMenu.AddLinkedBool("使用 W 丨目标在中心", true));
        BoolLinks.Add("misc_r", miscMenu.AddLinkedBool("大招延迟", true));
        SliderLinks.Add("misc_r_min_delay", miscMenu.AddLinkedSlider("R 最小延迟", 800, 0, 1500));
        SliderLinks.Add("misc_r_max_delay", miscMenu.AddLinkedSlider("R 最大延迟", 1750, 1500, 3000));
        SliderLinks.Add("misc_r_dash", miscMenu.AddLinkedSlider("R 延迟丨突进", 500, 0, 2000));
        BoolLinks.Add("misc_r_blue", miscMenu.AddLinkedBool("使用蓝色小灯泡", true));
    }
