...
namespace yol0Thresh
{
    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            menuDrawing.AddItem(new MenuItem("orb_Draw_AARange", "AA 范 围").SetValue(new Circle(true, Color.FloralWhite)));
            ...
            menuMisc.AddItem(new MenuItem("orb_Misc_Holdzone", "控制 区域").SetValue(new Slider(50, 100, 0)));
            ...
            menuMisc.AddItem(new MenuItem("orb_Misc_Priority_Unit", "优先 单位").SetValue(new StringList(new[] { "Minion", "Hero" })));
            ...
            var menuModes = new Menu("走砍 模式", "orb_Modes");
            {
                ...
                modeHarass.AddItem(new MenuItem("Harass_Key", "骚扰 按键").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeLaneClear.AddItem(new MenuItem("LaneClear_Key", "清线 按键").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeLaneFreeze.AddItem(new MenuItem("LaneFreeze_Key", "控线 按键").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeLasthit.AddItem(new MenuItem("LastHit_Key", "补刀 按键").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeFlee.AddItem(new MenuItem("Flee_Key", "逃跑 按键").SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                menuModes.AddSubMenu(modeFlee);
            }
            menu.AddSubMenu(menuModes);
            menu.AddItem(new MenuItem("xSLx_info", "作者 xSLx"));
            menu.AddItem(new MenuItem("xSLx_info2", "合作: xSLx & Esk0r"));
