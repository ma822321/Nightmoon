        ...
        public static void AddToMainMenu(Menu MainMenu)
        {
            ...
            var OWMenu = new Menu("走砍", "OW");
            {
                var DrawMenu = new Menu("显示", "Draw");
                {
                    ...
                    DrawMenu.AddItem(new MenuItem("OW_Draw_HpBar", "小兵血条").SetValue(new Circle(false, Color.Black)));
                    DrawMenu.AddItem(new MenuItem("OW_Draw_HpBarThickness", "-> 血条厚度").SetValue(new Slider(1, 1, 3)));
                    DrawMenu.AddItem(new MenuItem("OW_Draw_LastHit", "显示补刀").SetValue(new Circle(false, Color.Lime)));
                    DrawMenu.AddItem(new MenuItem("OW_Draw_NearKill", "附近可击杀小兵").SetValue(new Circle(false, Color.Gold)));
                    OWMenu.AddSubMenu(DrawMenu);
                }
                var MiscMenu = new Menu("杂项", "Misc");
                {
                    MiscMenu.AddItem(new MenuItem("OW_Misc_HoldZone", "防守范围").SetValue(new Slider(50, 0, 150)));
                    MiscMenu.AddItem(new MenuItem("OW_Misc_FarmDelay", "打钱延迟").SetValue(new Slider(0, 0, 300)));
                    MiscMenu.AddItem(new MenuItem("OW_Misc_MoveDelay", "移动延迟").SetValue(new Slider(0, 0, 150)));
                    ...
                    MiscMenu.AddItem(new MenuItem("OW_Misc_AllMovementDisabled", "禁止移动").SetValue(false));
                    MiscMenu.AddItem(new MenuItem("OW_Misc_AllAttackDisabled", "禁止攻击").SetValue(false));
                ...
                var ModeMenu = new Menu("模式", "Mode");
                {
                    ...
                    {
                        ComboMenu.AddItem(new MenuItem("OW_Combo_Key", "按键").SetValue(new KeyBind(32, KeyBindType.Press)));
                    ...
                    {
                        HarassMenu.AddItem(new MenuItem("OW_Harass_Key", "按键").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
                        ...
                        HarassMenu.AddItem(new MenuItem("OW_Harass_LastHit", "补刀").SetValue(true));
                    ...
                    var LastHitMenu = new Menu("补刀", "OW_LastHit");
                    {
                        LastHitMenu.AddItem(new MenuItem("OW_LastHit_Key", "按键").SetValue(new KeyBind(17, KeyBindType.Press)));
