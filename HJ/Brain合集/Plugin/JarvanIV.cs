...
namespace BrianSharp.Plugin
{
    class JarvanIV : Common.Helper
    {
        ...
        public JarvanIV()
        {
            ...
            var ChampMenu = new Menu("花边-Brain皇子", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    AddItem(ComboMenu, "Q", "使用 Q");
                    AddItem(ComboMenu, "W", "使用 W");
                    AddItem(ComboMenu, "WHpU", "W -> 自己Hp低于", 40);
                    AddItem(ComboMenu, "WCountA", "W -> 敌人数", 2, 1, 5);
                    AddItem(ComboMenu, "E", "使用 E");
                    AddItem(ComboMenu, "R", "使用 R");
                    AddItem(ComboMenu, "RHpU", "R -> 敌人Hp", 40);
                ...
                var HarassMenu = new Menu("骚扰", "Harass");
                {
                    ...
                    AddItem(HarassMenu, "AutoQMpA", "自动Q -> 最低蓝量", 50);
                    AddItem(HarassMenu, "Q", "使用 Q");
                    AddItem(HarassMenu, "QHpA", "Q -> 目标血量", 20);
                ...
                var ClearMenu = new Menu("清线/清野", "Clear");
                {
                    ...
                    AddItem(ClearMenu, "WHpU", "W -> 自己Hp低于", 40);
