...
namespace BrianSharp.Plugin
{
    class Maokai : Common.Helper
    {
        public Maokai()
        {
            ...
            var ChampMenu = new Menu("花边-Brain大树", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    ...
                    AddItem(ComboMenu, "RKill", "R -> 击杀自动取消");
                    AddItem(ComboMenu, "RMpU", "R -> 最低蓝量", 20);
                    ChampMenu.AddSubMenu(ComboMenu);
                }
                var HarassMenu = new Menu("骚扰", "Harass");
                {
                    AddItem(HarassMenu, "AutoQ", "使用 Q", "H", KeyBindType.Toggle);
                    AddItem(HarassMenu, "AutoQMpA", "Q-> 最低蓝量", 50);
                    AddItem(HarassMenu, "Q", "使用 Q");
                    AddItem(HarassMenu, "W", "使用 W");
                    AddItem(HarassMenu, "WHpA", "W-> 最低血量", 20);
                ...
                var MiscMenu = new Menu("杂项", "Misc");
                {
                    ...
                    var AntiGapMenu = new Menu("阻止突进", "AntiGap");
                    {
                        ...
                        AddItem(AntiGapMenu, "QSlow", "Q -> 慢 假如能击退");
