...
namespace BrianSharp.Plugin
{
    class DrMundo : Common.Helper
    {
        public DrMundo()
        {
            ...
            var ChampMenu = new Menu("花边-Brain梦多", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    AddItem(ComboMenu, "Q", "使用 Q");
                    AddItem(ComboMenu, "QCol", "Q -> 惩戒控制");
                    AddItem(ComboMenu, "W", "使用 W");
                    AddItem(ComboMenu, "WHpA", "W -> 血量", 20);
                    AddItem(ComboMenu, "E", "使用 E");
                    AddItem(ComboMenu, "R", "使用 R");
                    AddItem(ComboMenu, "RHpU", "R -> 自己Hp低于", 50);
                    ChampMenu.AddSubMenu(ComboMenu);
                }
                var HarassMenu = new Menu("骚扰", "Harass");
                {
                    AddItem(HarassMenu, "AutoQ", "使用 Q", "H", KeyBindType.Toggle);
                    AddItem(HarassMenu, "AutoQHpA", "Q -> 最低血量", 30);
                ...
                var ClearMenu = new Menu("清线/清野", "Clear");
                {
                    ...
                    AddItem(ClearMenu, "WHpA", "W -> 最低血量", 20);
