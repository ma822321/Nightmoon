...
namespace BrianSharp.Plugins
{
    class Garen : Common.Helper
    {
        public Garen()
        {
            ...
            var ChampMenu = new Menu("花边-Brain盖伦", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    var KillableMenu = new Menu("R击杀", "Killable");
                    {
                    ...
                    AddItem(ComboMenu, "WHpU", "W -> 自己Hp", 60);
                ...
                var ClearMenu = new Menu("清线/清野", "Clear");
                {
                    ...
                    AddItem(ClearMenu, "QMode", "Q -> 模式", new[] { "接 AA", "击杀" });
                ...
                var MiscMenu = new Menu("杂项", "Misc");
                {
                    ...
                    AddItem(MiscMenu, "QLastHit", "使用 Q 补刀");
