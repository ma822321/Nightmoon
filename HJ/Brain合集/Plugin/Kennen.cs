...
namespace BrianSharp.Plugin
{
    class Kennen : Common.Helper
    {
        public Kennen()
        {
            ...
            var ChampMenu = new Menu("花边-Brain凯南", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    ...
                    AddItem(ComboMenu, "RItem", "R -> 使用R 自动中亚");
                    AddItem(ComboMenu, "RItemHpU", "R --> 血量", 60);
                    ChampMenu.AddSubMenu(ComboMenu);
                }
                var HarassMenu = new Menu("骚扰", "Harass");
                {
                    AddItem(HarassMenu, "AutoQ", "使用 Q", "H", KeyBindType.Toggle);
                    AddItem(HarassMenu, "AutoQMpA", "自动Q-> 最低查克拉", 50);
                    AddItem(HarassMenu, "Q", "使用 Q");
                    AddItem(HarassMenu, "W", "使用 W");
                    AddItem(HarassMenu, "WMpA", "W-> 最低查克拉", 50);
