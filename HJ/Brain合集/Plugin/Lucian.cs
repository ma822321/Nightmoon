...
namespace BrianSharp.Plugin
{
    class Lucian : Common.Helper
    {
        ...
        public Lucian()
        {
            ...
            var ChampMenu = new Menu("花边-Brain奥巴牛", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    AddItem(ComboMenu, "P", "使用被动");
                    AddItem(ComboMenu, "PSave", "-> 保持被动", false);
                    AddItem(ComboMenu, "Q", "使用 Q");
                    AddItem(ComboMenu, "QExtend", "Q -> 延长");
                    AddItem(ComboMenu, "W", "使用 W");
                    AddItem(ComboMenu, "WPred", "W -> 预判", false);
                    AddItem(ComboMenu, "E", "使用 E");
                    AddItem(ComboMenu, "EGap", "E -> 突进");
                    AddItem(ComboMenu, "EDelay", "E -> 禁止Q W丨如果E在CD", 500, 0, 1000);
                    AddItem(ComboMenu, "EMode", "E -> 模式", new[] { "安全", "鼠标", "追杀" });
                    AddItem(ComboMenu, "EModeKey", "E --> 开关", "Z", KeyBindType.Toggle).ValueChanged += ComboEModeChanged;
                    AddItem(ComboMenu, "EModeDraw", "E --> 显示文本", false);
                    AddItem(ComboMenu, "R", "使用 R (可击杀)");
                    AddItem(ComboMenu, "RItem", "R -> 使用幽梦");
                    ChampMenu.AddSubMenu(ComboMenu);
                }
                var HarassMenu = new Menu("骚扰", "Harass");
                {
                    AddItem(HarassMenu, "AutoQ", "使用 Q 延长", "H", KeyBindType.Toggle);
                    AddItem(HarassMenu, "AutoQMpA", "自动Q -> 蓝量", 50);
                    AddItem(HarassMenu, "P", "使用被动");
                    AddItem(HarassMenu, "PSave", "-> 保持被动", false);
                    AddItem(HarassMenu, "Q", "使用 Q");
                    AddItem(HarassMenu, "W", "使用 W");
                    AddItem(HarassMenu, "E", "使用 E");
                    AddItem(HarassMenu, "EHpA", "E -> 自己血量", 20);
                ...
                var ClearMenu = new Menu("清线/清野", "Clear");
                {
                    ...
                    AddItem(ClearMenu, "EDelay", "E -> 禁止Q W丨如果E在CD", 500, 0, 1000);
                ...
                var MiscMenu = new Menu("杂项", "Misc");
                {
                    ...
                    AddItem(MiscMenu, "LockR", "锁定 R 目标");
