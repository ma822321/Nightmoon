...
namespace BrianSharp.Plugin
{
    class Aatrox : Common.Helper
    {
        public Aatrox()
        {
            ...
            var ChampMenu = new Menu("花边-Brain剑魔", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    AddItem(ComboMenu, "Q", "使用 Q");
                    AddItem(ComboMenu, "W", "使用 W");
                    AddItem(ComboMenu, "WHpU", "W -> 切换到补血 自己Hp低于", 50);
                    AddItem(ComboMenu, "E", "使用 E");
                    AddItem(ComboMenu, "R", "使用 R");
                    AddItem(ComboMenu, "RHpU", "R -> 敌人血量", 60);
                ...
                var HarassMenu = new Menu("骚扰", "Harass");
                {
                    ...
                    AddItem(HarassMenu, "AutoEHpA", "自动E -> 自己血量", 50);
                    AddItem(HarassMenu, "Q", "使用 Q");
                    AddItem(HarassMenu, "QHpA", "Q -> 自己血量", 20);
                ...
                var ClearMenu = new Menu("清线/清野", "Clear");
                {
                    ...
                    AddItem(ClearMenu, "WPriority", "-> 优先补血");
                    AddItem(ClearMenu, "WHpU", "W -> 切换到补血 自己Hp低于", 50);
