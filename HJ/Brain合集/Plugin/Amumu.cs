...
namespace BrianSharp.Plugin
{
    class Amumu : Common.Helper
    {
        public Amumu()
        {
            ...
            var ChampMenu = new Menu("花边-Brain阿木木", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    AddItem(ComboMenu, "Q", "使用 Q");
                    AddItem(ComboMenu, "QCol", "Q -> 碰撞检测");
                    AddItem(ComboMenu, "W", "使用 W");
                    AddItem(ComboMenu, "WMpA", "W -> 最低蓝量", 20);
                ...
                var HarassMenu = new Menu("骚扰", "Harass");
                {
                    ...
                    AddItem(HarassMenu, "WMpA", "W-> 最低蓝量", 20);
                ...
                var ClearMenu = new Menu("清线/清野", "Clear");
                {
                    ...
                    AddItem(ClearMenu, "WMpA", "W -> 最低蓝量", 20);
