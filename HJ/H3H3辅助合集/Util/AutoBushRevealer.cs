...
namespace Support.Util
{
    ...
    public class AutoBushRevealer
    {
        ...
        public AutoBushRevealer(Menu menu)
        {
            ...
            _menu = menu.AddSubMenu(new Menu("Auto Bush Revealer", "草丛探测器"));
            _menu.AddItem(new MenuItem("Auto Bush Revealer", "自动探测草丛").SetValue(true));
            _menu.AddItem(new MenuItem("AutoBushEnabled", "开 启").SetValue(true));

            var useWardsMenu = _menu.AddSubMenu(new Menu("使用 侦查守卫: ", "AutoBushUseWards"));
