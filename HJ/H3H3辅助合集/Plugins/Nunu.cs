...
namespace Support.Plugins
{
    ...
    public class Nunu : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("Combo.Q.Health", "使用Q丨生命百分比", 50, 1, 100);
        }
        ...
        public override void HarassMenu(Menu config)
        {
            ...
            config.AddSlider("Harass.Q.Health", "使用Q丨生命百分比", 50, 1, 100);
        }

        public override void MiscMenu(Menu config)
        {
            config.AddList("Misc.Laugh", "嘲讽 对面", new[] { "关闭", "开启", "嘲讽 + 动作" });
        }

        public override void InterruptMenu(Menu config)
        {
            config.AddBool("Gapcloser.E", "使用 E 丨阻止突进", true);
        }
    }
}