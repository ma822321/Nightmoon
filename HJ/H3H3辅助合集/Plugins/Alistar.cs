...
namespace Support.Plugins
{
    ...
    public class Alistar : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("Combo.E.Health", "生命回复", 20, 1, 100);
        }
        ...
        public override void HarassMenu(Menu config)
        {
            ...
            config.AddSlider("Harass.E.Health", "生命回复", 20, 1, 100);
        }

        public override void InterruptMenu(Menu config)
        {
            config.AddBool("Gapcloser.W", "使用 W 丨阻止突进", true);

            config.AddBool("Interrupt.Q", "使用 Q 丨打断法术", true);
            config.AddBool("Interrupt.W", "使用 W 丨打断法术", true);
        }
    }
}