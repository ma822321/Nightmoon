    ...
    class Ahri : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("按 键", "Key");{
                ...
                key.AddItem(new MenuItem("charmCombo", "连招时E中对面自动Q",true).SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Toggle)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var combo = new Menu("连 招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("qHit", "Q/E 命中", true).SetValue(new Slider(3, 1, 4)));
                ...
                combo.AddItem(new MenuItem("rSpeed", "单挑时 使用3段R",true).SetValue(true));
                //add to menu
            ...
            var harass = new Menu("骚扰", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("qHit2", "Q/E 命中", true).SetValue(new Slider(3, 1, 4)));
                ...
                harass.AddItem(new MenuItem("longQ", "远距离丨使用Q", true).SetValue(true));
                harass.AddItem(new MenuItem("charmHarass", "对面被E中时丨使用Q", true).SetValue(true)); 
               //add to menu
            ...
            {
                misc.AddItem(new MenuItem("UseInt", "使用 E 丨打断", true).SetValue(true));
                misc.AddItem(new MenuItem("UseGap", "使用 E 丨阻止突进", true).SetValue(true));
                misc.AddItem(new MenuItem("mana", "使用R 丨检测蓝量", true).SetValue(true));
                misc.AddItem(new MenuItem("dfgCharm", "E中接冥火",true).SetValue(true));
                misc.AddItem(new MenuItem("EQ", "使用 Q丨条件:对面被 E", true).SetValue(true));
                misc.AddItem(new MenuItem("smartKS", "智能 击杀",true).SetValue(true));
                misc.AddItem(new MenuItem("Prediction_Check_Off", "使用 预判模式 2",true).SetValue(false));
                //add to menu
            ...
            var drawing = new Menu("范 围", "Drawings");
            {
                ...
                drawing.AddItem(
                        new MenuItem("cursor", "显示 R 突进 距离",true).SetValue(new Circle(false,Color.FromArgb(100, 255, 0, 255))));
                drawing.AddItem(
                        new MenuItem("Draw_Mode", "显示 E 模式",true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
