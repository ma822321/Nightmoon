...
namespace UnderratedAIO.Champions
{
    class Chogath
    {
        ...
        {
            config = new Menu("花边-上单大虫", "ChoGath", true);
            // Target Selector
            ...
            menuD.AddItem(new MenuItem("drawrrflash", "显示 R+闪现 范围")).SetValue(new Circle(true, Color.FromArgb(150, 250, 248, 110)));
            ...
            menuC.AddItem(new MenuItem("qHit", "Q 命中", true).SetValue(new Slider(3, 1, 4)));
            menuC.AddItem(new MenuItem("useqfaster", "使用快速 Q")).SetValue(false);
