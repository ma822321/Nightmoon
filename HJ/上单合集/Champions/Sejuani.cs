...
namespace UnderratedAIO.Champions
{
    class Sejuani
    {
        ...
        {
            config = new Menu("花边-上单猪妹", "Sejuani", true);
            // Target Selector
            ...
            menuC.AddItem(new MenuItem("useemin", "使用 E 最少人数")).SetValue(new Slider(1, 1, 5));
            ...
            menuC.AddItem(new MenuItem("manualR", "手动 R")).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press));
            menuC.AddItem(new MenuItem("useItems", "使用物品")).SetValue(true);
            menuC.AddItem(new MenuItem("useIgnite", "使用点燃")).SetValue(true);
            
            config.AddSubMenu(menuC);
            // Clear/Jungle
            Menu menuJ = new Menu("清线清野 ", "jsettings");
            menuJ.AddItem(new MenuItem("useqC", "使用 Q")).SetValue(true);
            menuJ.AddItem(new MenuItem("usewC", "使用 W")).SetValue(true);
            menuJ.AddItem(new MenuItem("useeCmin", "使用 E 最少数")).SetValue(new Slider(1, 1, 5));
            menuJ.AddItem(new MenuItem("useiC", "使用物品")).SetValue(true);
            menuJ.AddItem(new MenuItem("minmana", "最低蓝量比")).SetValue(new Slider(1, 1, 100));
            ...
            menuU.AddItem(new MenuItem("useqgc", "使用 Q 突进")).SetValue(false);
            menuU.AddItem(new MenuItem("useqint", "使用 Q 打断技能")).SetValue(true);
            menuU.AddItem(new MenuItem("usergc", "使用 R 突进")).SetValue(false);
