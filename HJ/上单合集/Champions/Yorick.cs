...
namespace UnderratedAIO.Champions
{
    class Yorick
    {
       ...
       {
           config = new Menu("花边-上单掘墓者", "Yorick", true);
           // Target Selector
           ...
           menuC.AddItem(new MenuItem("atpercenty", "大招给队友丨Hp<")).SetValue(new Slider(30, 0, 100));
           ...
           menuM.AddItem(new MenuItem("ghostTarget", "幽灵目标")).SetValue(new StringList(new[] { "手动选择", "残血", "附近" }, 0));
