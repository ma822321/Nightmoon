...
namespace DZAIO.Champions
{
    class Lux : IChampion
    {
        ...
        public void OnLoad(Menu menu)
        {
            ...
            var comboMenu = new Menu("光辉 - 连招", "dzaio.lux.combo");
            ...
            var skillOptionMenu = new Menu("技能 设置", "dzaio.lux.combo.skilloptions");
           skillOptionMenu.AddItem(new MenuItem("dzaio.lux.combo.skilloptions.eafterr", "引爆E后R").SetValue(true));
           comboMenu.AddSubMenu(skillOptionMenu);

            menu.AddSubMenu(comboMenu);
            var harrassMenu = new Menu("光辉 - 骚扰", "dzaio.lux.harrass");
            ...
            var farmMenu = new Menu("光辉 - 打钱", "dzaio.lux.farm");
            ...
            var miscMenu = new Menu("光辉 - 杂项", "dzaio.lux.misc");
            {
                miscMenu.AddItem(new MenuItem("dzaio.lux.misc.antigapcloserq", "使用Q丨阻止突进").SetValue(true));
            }
            miscMenu.AddHitChanceSelector();
            menu.AddSubMenu(miscMenu);
            var drawMenu = new Menu("光辉 - 范围", "dzaio.lux.draw");
