    ...
    internal class Ezreal : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            var xRMenu = new Menu("R", "ComboR");
            {
                ...
                xRMenu.AddItem(new MenuItem("UseRCMinRange", "最小. 范围").SetValue(new Slider(200, 200, 1000)));
                xRMenu.AddItem(new MenuItem("UseRCMaxRange", "最大. 范围").SetValue(new Slider(500, 500, 2000)));
                xRMenu.AddItem(
                    new MenuItem("DrawRMin", "显示 最小. R 范围").SetValue(
                        new Circle(true, System.Drawing.Color.DarkRed)));
                xRMenu.AddItem(
                    new MenuItem("DrawRMax", "显示 最大. R 范围").SetValue(
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddSubMenu(new Menu("禁止Q自动骚扰对象", "DontQToggleHarass"));
            config.AddSubMenu(new Menu("禁止W自动骚扰对象", "DontWToggleHarass"));
            {
            ...
            config.AddItem(
                new MenuItem("UseQTH", "Q (自动)").SetValue(new KeyBind("H".ToCharArray()[0], KeyBindType.Toggle)));
            config.AddItem(
                new MenuItem("UseWTH", "W (自动)").SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Toggle)));
            config.AddItem(new MenuItem("DrawHarassToggleStatus", "显示 自动 状态").SetValue(true));
            return true;
        }
        ...
        public override bool DrawingMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("DrawW" + Id, "W 范围").SetValue(
                    new Circle(false, System.Drawing.Color.FromArgb(100, 255, 255, 255))));
            config.AddItem(new MenuItem("ShowKillableStatus", "显示 击杀 状态").SetValue(true));
