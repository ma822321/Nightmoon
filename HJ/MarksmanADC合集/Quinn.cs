...
namespace Marksman
{
    internal class Quinn : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseETC" + Id, "不在塔下 E").SetValue(true));
            config.AddItem(new MenuItem("UseETK" + Id, "塔下E丨假如能击杀")
                .SetValue(true));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseETH" + Id, "不在塔下 E").SetValue(true));
            config.AddItem(
