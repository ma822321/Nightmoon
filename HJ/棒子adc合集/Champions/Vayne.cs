...
namespace Sharpshooter.Champions
{
    public static class Vayne
    {
        ...
        public static void Load()
        {
            ...
            var drawDamageMenu = new MenuItem("Draw_RDamage", "显示 W伤害", true).SetValue(true);
            var drawFill = new MenuItem("Draw_Fill", "显示 W充能伤害", true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("antigapcloser", "阻止 突进", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("autointerrupt", "打断 法术", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("AutoRQ", "自动Q丨开启R", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("LogicalQ", "逻辑 Q", true).SetValue(true));
            ...
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingP", "被动 范围", true).SetValue(new Circle(true, Color.FromArgb(183, 0, 0))));
            ...
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingRtimer", "R 倒计时", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingCond", "E 碰撞判定", true).SetValue(new Circle(true, Color.Red)));
