...
namespace Sharpshooter.Champions
{
    public static class Sivir
    {
        ...
        public static void Load()
        {
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("AutoQ", "自动 Q丨目标被控制", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("AutoE", "自动 E丨抵挡技能", true).SetValue(true));

            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "AA 范围", true).SetValue(new Circle(true, Color.FromArgb(170,78,25))));
