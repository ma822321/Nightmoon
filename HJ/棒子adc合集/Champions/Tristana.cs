...
namespace Sharpshooter.Champions
{
    public static class Tristana
    {
        ...
        public static void Load()
        {
            ...
            var drawDamageMenu = new MenuItem("Draw_RDamage", "显示 E R伤害", true).SetValue(true);
            var drawFill = new MenuItem("Draw_Fill", "显示 E R充能伤害", true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("killsteal", "抢人头 (R)", true).SetValue(true));

            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "AA 范围", true).SetValue(new Circle(true, Color.FromArgb(255, 178, 217))));
